%% -----------------------------------------------------------------------------
%% SQL codec. The main code is borrowed from sqlparse
%%
...
procedure_call -> BEGIN function_ref_list END : {begin_procedure, '$2'}.
procedure_call -> BEGIN sql_list          END : {begin_procedure, '$2'}.
procedure_call -> CALL  function_ref          : {call_procedure, '$2'}.
...
create_role_def -> CREATE ROLE NAME : {create_role, unwrap_bin('$3')}.

create_table_def -> CREATE             TABLE table '('                              ')'            : {create_table, '$3', [], [], []}.
create_table_def -> CREATE             TABLE table '('                              ')' table_opts : {create_table, '$3', [], [], '$5'}.
create_table_def -> CREATE             TABLE table '(' base_table_element_commalist ')'            : {create_table, '$3', '$5', [], []}.
create_table_def -> CREATE             TABLE table '(' base_table_element_commalist ')' table_opts : {create_table, '$3', '$5', [], '$7'}.
create_table_def -> CREATE create_opts TABLE table '('                              ')'            : {create_table, '$4', [],   '$2', []}.
create_table_def -> CREATE create_opts TABLE table '('                              ')' table_opts : {create_table, '$4', [], '$2', '$7'}.
create_table_def -> CREATE create_opts TABLE table '(' base_table_element_commalist ')'            : {create_table, '$4', '$6', '$2', []}.
create_table_def -> CREATE create_opts TABLE table '(' base_table_element_commalist ')' table_opts : {create_table, '$4', '$6', '$2', '$8'}.

create_user_def -> CREATE USER NAME identified                : {create_user, unwrap_bin('$3'), '$4', []}.
create_user_def -> CREATE USER NAME identified user_opts_list : {create_user, unwrap_bin('$3'), '$4', '$5'}.

drop_table_def -> DROP      TABLE        table_list                  : {drop_table, {'tables', '$3'}, {},   {},   []}.
drop_table_def -> DROP      TABLE        table_list restrict_cascade : {drop_table, {'tables', '$3'}, {},   '$4', []}.
drop_table_def -> DROP      TABLE exists table_list                  : {drop_table, {'tables', '$4'}, '$3', {},   []}.
drop_table_def -> DROP      TABLE exists table_list restrict_cascade : {drop_table, {'tables', '$4'}, '$3', '$5', []}.
drop_table_def -> DROP NAME TABLE        table_list                  : {drop_table, {'tables', '$4'}, {},   {},   unwrap('$2')}.
drop_table_def -> DROP NAME TABLE        table_list restrict_cascade : {drop_table, {'tables', '$4'}, {},   '$5', unwrap('$2')}.
drop_table_def -> DROP NAME TABLE exists table_list                  : {drop_table, {'tables', '$5'}, '$4', {},   unwrap('$2')}.
drop_table_def -> DROP NAME TABLE exists table_list restrict_cascade : {drop_table, {'tables', '$5'}, '$4', '$6', unwrap('$2')}.

drop_role_def -> DROP ROLE NAME : {drop_role, unwrap_bin('$3')}.

drop_index_def -> DROP INDEX            FROM table : {drop_index, {},   '$4'}.
drop_index_def -> DROP INDEX index_name            : {drop_index, '$3', []}.
drop_index_def -> DROP INDEX index_name FROM table : {drop_index, '$3', '$5'}.

create_index_def -> CREATE                   INDEX            ON table_alias                                                         : {create_index, {},   {},   '$4', [],   {},   {}}.
create_index_def -> CREATE                   INDEX            ON table_alias                                     create_index_filter : {create_index, {},   {},   '$4', [],   {},   '$5'}.
create_index_def -> CREATE                   INDEX            ON table_alias                   create_index_norm                     : {create_index, {},   {},   '$4', [],   '$5', {}}.
create_index_def -> CREATE                   INDEX            ON table_alias                   create_index_norm create_index_filter : {create_index, {},   {},   '$4', [],   '$5', '$6'}.
create_index_def -> CREATE                   INDEX            ON table_alias create_index_spec                                       : {create_index, {},   {},   '$4', '$5', {},   {}}.
create_index_def -> CREATE                   INDEX            ON table_alias create_index_spec                   create_index_filter : {create_index, {},   {},   '$4', '$5', {},   '$6'}.
create_index_def -> CREATE                   INDEX            ON table_alias create_index_spec create_index_norm                     : {create_index, {},   {},   '$4', '$5', '$6', {}}.
create_index_def -> CREATE                   INDEX            ON table_alias create_index_spec create_index_norm create_index_filter : {create_index, {},   {},   '$4', '$5', '$6', '$7'}.
create_index_def -> CREATE                   INDEX index_name ON table_alias                                                         : {create_index, {},   '$3', '$5', [],   {},   {}}.
create_index_def -> CREATE                   INDEX index_name ON table_alias                                     create_index_filter : {create_index, {},   '$3', '$5', [],   {},   '$6'}.
create_index_def -> CREATE                   INDEX index_name ON table_alias                   create_index_norm                     : {create_index, {},   '$3', '$5', [],   '$6', {}}.
create_index_def -> CREATE                   INDEX index_name ON table_alias                   create_index_norm create_index_filter : {create_index, {},   '$3', '$5', [],   '$6', '$7'}.
create_index_def -> CREATE                   INDEX index_name ON table_alias create_index_spec                                       : {create_index, {},   '$3', '$5', '$6', {},   {}}.
create_index_def -> CREATE                   INDEX index_name ON table_alias create_index_spec                   create_index_filter : {create_index, {},   '$3', '$5', '$6', {},   '$7'}.
create_index_def -> CREATE                   INDEX index_name ON table_alias create_index_spec create_index_norm create_index_filter : {create_index, {},   '$3', '$5', '$6', '$7', '$8'}.
create_index_def -> CREATE                   INDEX index_name ON table_alias create_index_spec create_index_norm                     : {create_index, {},   '$3', '$5', '$6', '$7', {}}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias                                                         : {create_index, '$2', {},   '$5', [],   {},   {}}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias                                     create_index_filter : {create_index, '$2', {},   '$5', [],   {},   '$6'}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias                   create_index_norm                     : {create_index, '$2', {},   '$5', [],   '$6', {}}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias                   create_index_norm create_index_filter : {create_index, '$2', {},   '$5', [],   '$6', '$7'}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias create_index_spec                                       : {create_index, '$2', {},   '$5', '$6', {},   {}}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias create_index_spec                   create_index_filter : {create_index, '$2', {},   '$5', '$6', {},   '$7'}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias create_index_spec create_index_norm                     : {create_index, '$2', {},   '$5', '$6', '$7', {}}.
create_index_def -> CREATE create_index_opts INDEX            ON table_alias create_index_spec create_index_norm create_index_filter : {create_index, '$2', {},   '$5', '$6', '$7', '$8'}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias                                                         : {create_index, '$2', '$4', '$6', [],   {},   {}}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias                                     create_index_filter : {create_index, '$2', '$4', '$6', [],   {},   '$7'}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias                   create_index_norm                     : {create_index, '$2', '$4', '$6', [],   '$7', {}}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias                   create_index_norm create_index_filter : {create_index, '$2', '$4', '$6', [],   '$7', '$8'}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias create_index_spec                                       : {create_index, '$2', '$4', '$6', '$7', {},   {}}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias create_index_spec                   create_index_filter : {create_index, '$2', '$4', '$6', '$7', {},   '$8'}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias create_index_spec create_index_norm                     : {create_index, '$2', '$4', '$6', '$7', '$8', {}}.
create_index_def -> CREATE create_index_opts INDEX index_name ON table_alias create_index_spec create_index_norm create_index_filter : {create_index, '$2', '$4', '$6', '$7', '$8', '$9'}.
...
create_index_spec_column -> NAME '(' sgn_num ')'             : {unwrap_bin('$1'), '$3'}.
create_index_spec_column -> NAME '(' sgn_num ',' sgn_num ')' : {unwrap_bin('$1'), '$3', '$5'}.
...
table_opts -> table_opt                : ['$1'].
table_opts -> table_opt table_opts     : ['$1'|'$2'].
table_opts -> table_opt ',' table_opts : ['$1'|'$3'].

table_opt -> table_opt_name '=' table_opt_val : setelement(2, '$1', '$3').
table_opt -> table_opt_name table_opt_val : setelement(2, '$1', '$2').

table_opt_name -> DEFAULT CHARACTER SET : {charset, <<"">>, true}.
table_opt_name -> CHARACTER SET         : {charset, <<"">>, false}.
table_opt_name -> DEFAULT COLLATE       : {collate, <<"">>, true}.
table_opt_name -> COLLATE               : {collate, <<"">>, false}.
table_opt_name -> ENGINE                : {engine,  <<"">>}.  

table_opt_val -> STRING : unwrap_bin('$1').
table_opt_val -> NAME   : unwrap_bin('$1').
...
alter_user_def -> ALTER USER NAME NAME NAME         : {alter_user, unwrap_bin('$3'), {'spec', [case {string:to_lower(unwrap('$4')), string:to_lower(unwrap('$5'))} of
...
alter_table_def -> ALTER TABLE table alter_specs : {alter_table, '$3', '$4'}.

alter_specs -> alter_spec                 : ['$1'].
alter_specs -> alter_spec ',' alter_specs : ['$1'|'$2'].
alter_specs -> alter_spec alter_specs     : ['$1'|'$2'].

alter_spec -> ADD FOREIGN KEY index_name reference_definition : {add, foreign_key, '$4', '$5'}.
...
proxy_clause -> GRANT  CONNECT THROUGH db_user_proxy    : {grant_connect, '$4'}.
proxy_clause -> REVOKE CONNECT THROUGH ENTERPRISE USERS : {revoke_connect, enterprise_users}.
proxy_clause -> REVOKE CONNECT THROUGH db_user_proxy    : {revoke_connect, '$4'}.
...
proxy_with -> WITH ROLE            role_list : {with_role, '$3'}.
proxy_with -> WITH ROLE ALL EXCEPT role_list : {'with role all except', '$5'}.

proxy_auth_req -> AUTHENTICATION REQUIRED : authentication_required.
...
user_role -> DEFAULT ROLE            role_list : {default_role, '$3'}.
...
identified -> IDENTIFIED EXTERNALLY         : {identified_extern,   {}}.
identified -> IDENTIFIED EXTERNALLY AS NAME : {identified_extern,   unwrap_bin('$4')}.
identified -> IDENTIFIED GLOBALLY           : {identified_globally, {}}.
identified -> IDENTIFIED GLOBALLY   AS NAME : {identified_globally, unwrap_bin('$4')}.

user_opts_list -> user_opt                : ['$1'].
user_opts_list -> user_opt user_opts_list : ['$1'] ++ '$2'.

user_opt -> DEFAULT   TABLESPACE NAME : [{default_tablespace, unwrap_bin('$3')}].
user_opt -> TEMPORARY TABLESPACE NAME : [{temporary_tablespace, unwrap_bin('$3')}].
...
column_def_opt -> AUTO_INCREMENT                            : auto_increment.
column_def_opt -> UNIQUE                                    : unique.
column_def_opt -> NOT NULLX                                 : not_null.
column_def_opt -> NOT NULLX UNIQUE                          : 'not null unique'.
column_def_opt -> NOT NULLX PRIMARY KEY                     : 'not null primary key'.
column_def_opt -> PRIMARY KEY                               : 'primary key'.
...
column_def_opt -> IDENTITY '(' sgn_num ',' sgn_num ')'      : {identity, '$3', '$5'}.
column_def_opt -> reference_definition                      : '$1'.

reference_definition -> REFERENCES table                          : {ref, '$2', undefined}.
reference_definition -> REFERENCES table ref_opts                 : {ref, '$2', '$3'}.
reference_definition -> REFERENCES table '(' column_commalist ')' : {ref, {'$2', '$4'}, undefined}.
reference_definition -> REFERENCES table '(' column_commalist ')' ref_opts : {ref, {'$2', '$4'}, '$6'}.

table_constraint_def ->                 UNIQUE      '(' column_commalist ')'                                           : {unique,        [],               '$3'}.
table_constraint_def ->                 PRIMARY KEY     create_index_spec                                              : {primary_key, [],               '$3'}.
table_constraint_def ->                 FOREIGN KEY '(' column_commalist ')' REFERENCES table                          : {foreign_key, [],               '$4', {'ref', '$7'}}.
table_constraint_def ->                 FOREIGN KEY '(' column_commalist ')' REFERENCES table '(' column_commalist ')' : {foreign_key, [],               '$4', {'ref', {'$7', '$9'}}}.
...
table_constraint_def -> CONSTRAINT NAME PRIMARY KEY '(' column_commalist ')'                                           : {primary_key, unwrap_bin('$2'), '$6'}.
table_constraint_def -> CONSTRAINT NAME FOREIGN KEY '(' column_commalist ')' REFERENCES table                          : {foreign_key, unwrap_bin('$2'), '$6', {'ref', '$9'}}.
table_constraint_def -> CONSTRAINT NAME FOREIGN KEY '(' column_commalist ')' REFERENCES table '(' column_commalist ')' : {foreign_key, unwrap_bin('$2'), '$6', {'ref', {'$9', '$11'}}}.
...
ref_opts -> ref_opt          : ['$1'].
ref_opts -> ref_opt ref_opts : ['$1'|'$2'].

ref_opt -> ON UPDATE ref_opt_type : {on_update, '$3'}.
ref_opt -> ON DELETE ref_opt_type : {on_delete, '$3'}.

ref_opt_type -> RESTRICT    : restrict.
ref_opt_type -> CASCADE     : cascade.
ref_opt_type -> SET NULLX   : set_null.
ref_opt_type -> NO ACTION   : no_action.
ref_opt_type -> SET DEFAULT : set_default.

view_def -> CREATE VIEW table                          AS query_spec                   : {create_view, '$3', [],   {as, '$5', []}}.
view_def -> CREATE VIEW table                          AS query_spec WITH CHECK OPTION : {create_view, '$3', [],   {as, '$5', "with check option"}}.
view_def -> CREATE VIEW table '(' column_commalist ')' AS query_spec                   : {create_view, '$3', '$5', {as, '$8', []}}.
view_def -> CREATE VIEW table '(' column_commalist ')' AS query_spec WITH CHECK OPTION : {create_view, '$3', '$5', {as, '$8', "with check option"}}.

grant_def -> GRANT ALL PRIVILEGES        on_obj_clause TO grantee_revokee_commalist                          : {grant, [all_privileges], '$4',         {to, '$6'},   ''}.
grant_def -> GRANT object_privilege_list on_obj_clause TO grantee_revokee_commalist                          : {grant, '$2',               '$3',         {to, '$5'},   ''}.
grant_def -> GRANT ALL PRIVILEGES        on_obj_clause TO grantee_identified_by                              : {grant, [all_privileges], '$4',         {to, ['$6']}, ''}.
grant_def -> GRANT object_privilege_list on_obj_clause TO grantee_identified_by                              : {grant, '$2',               '$3',         {to, ['$5']}, ''}.
grant_def -> GRANT ALL PRIVILEGES        on_obj_clause TO grantee_revokee_commalist object_with_grant_option : {grant, [all_privileges], '$4',         {to, '$6'},   '$7'}.
...
grant_def -> GRANT ALL PRIVILEGES        on_obj_clause TO grantee_identified_by     object_with_grant_option : {grant, [all_privileges], '$4',         {to, ['$6']}, '$7'}.
grant_def -> GRANT object_privilege_list on_obj_clause TO grantee_identified_by     object_with_grant_option : {grant, '$2',               '$3',         {to, ['$5']}, '$6'}.
grant_def -> GRANT ALL PRIVILEGES                      TO grantee_revokee_commalist                          : {grant, [all_privileges], {on, <<"">>}, {to, '$5'},   ''}.
grant_def -> GRANT system_privilege_list               TO grantee_revokee_commalist                          : {grant, '$2',               {on, <<"">>}, {to, '$4'},   ''}.
grant_def -> GRANT ALL PRIVILEGES                      TO grantee_identified_by                              : {grant, [all_privileges], {on, <<"">>}, {to, ['$5']}, ''}.
grant_def -> GRANT system_privilege_list               TO grantee_identified_by                              : {grant, '$2',               {on, <<"">>}, {to, ['$4']}, ''}.
grant_def -> GRANT ALL PRIVILEGES                      TO grantee_revokee_commalist system_with_grant_option : {grant, [all_privileges], {on, <<"">>}, {to, '$5'},   '$6'}.
grant_def -> GRANT system_privilege_list               TO grantee_revokee_commalist system_with_grant_option : {grant, '$2',               {on, <<"">>}, {to, '$4'},   '$5'}.
grant_def -> GRANT ALL PRIVILEGES                      TO grantee_identified_by     system_with_grant_option : {grant, [all_privileges], {on, <<"">>}, {to, ['$5']}, '$6'}.
grant_def -> GRANT system_privilege_list               TO grantee_identified_by     system_with_grant_option : {grant, '$2',               {on, <<"">>}, {to, ['$4']}, '$5'}.

revoke_def -> REVOKE ALL PRIVILEGES        on_obj_clause FROM grantee_revokee_commalist                           : {revoke, [all_privileges], '$4',         {from, '$6'}, ''}.
revoke_def -> REVOKE object_privilege_list on_obj_clause FROM grantee_revokee_commalist                           : {revoke, '$2',               '$3',         {from, '$5'}, ''}.
revoke_def -> REVOKE ALL PRIVILEGES        on_obj_clause FROM grantee_revokee_commalist object_with_revoke_option : {revoke, [all_privileges], '$4',         {from, '$6'}, '$7'}.
...
revoke_def -> REVOKE ALL PRIVILEGES                      FROM grantee_revokee_commalist                           : {revoke, [all_privileges], {on, <<"">>}, {from, '$5'}, ''}.
revoke_def -> REVOKE system_privilege_list               FROM grantee_revokee_commalist                           : {revoke, '$2',               {on, <<"">>}, {from, '$4'}, ''}.

grantee_identified_by -> NAME IDENTIFIED BY STRING : {identified_by, unwrap_bin('$1'), unwrap_bin('$4')}.
...
object_with_revoke_option -> CASCADE CONSTRAINTS : cascade_constraints.
object_with_revoke_option -> FORCE               : 'force'.

on_obj_clause -> ON DIRECTORY NAME : {on_directory, unwrap_bin('$3')}.
...
system_privilege -> CREATE TABLE                 : create_table.
system_privilege -> CREATE VIEW                  : create_view.
...
order_by_clause -> ORDER BY ordering_spec_commalist : {order_by, '$3'}.
...
manipulative_statement -> alter_table_def             : '$1'.
...
truncate_table -> TRUNCATE TABLE table                      : {truncate_table, '$3', {},   {}}.
truncate_table -> TRUNCATE TABLE table              storage : {truncate_table, '$3', {},   '$4'}.
truncate_table -> TRUNCATE TABLE table materialized         : {truncate_table, '$3', '$4', {}}.
truncate_table -> TRUNCATE TABLE table materialized storage : {truncate_table, '$3', '$4', '$5'}.
...
table_exp -> from_clause                                                                                      : ['$1', {where, {}}, {hierarchical_query, {}}, {group_by, []},  {having, {}}, {order_by, []}].
table_exp -> from_clause                                                                      order_by_clause : ['$1', {where, {}}, {hierarchical_query, {}}, {group_by, []},  {having, {}}, '$2'].
table_exp -> from_clause                                                        having_clause                 : ['$1', {where, {}}, {hierarchical_query, {}}, {group_by, []},  '$2',         {order_by, []}].
table_exp -> from_clause                                                        having_clause order_by_clause : ['$1', {where, {}}, {hierarchical_query, {}}, {group_by, []},  '$2',         '$3'].
table_exp -> from_clause                                        group_by_clause                               : ['$1', {where, {}}, {hierarchical_query, {}}, '$2',              {having, {}}, {order_by, []}].
table_exp -> from_clause                                        group_by_clause               order_by_clause : ['$1', {where, {}}, {hierarchical_query, {}}, '$2',              {having, {}}, '$3'].
table_exp -> from_clause                                        group_by_clause having_clause                 : ['$1', {where, {}}, {hierarchical_query, {}}, '$2',              '$3',         {order_by, []}].
table_exp -> from_clause                                        group_by_clause having_clause order_by_clause : ['$1', {where, {}}, {hierarchical_query, {}}, '$2',              '$3',         '$4'].
table_exp -> from_clause              hierarchical_query_clause                                               : ['$1', {where, {}}, '$2',                       {group_by, []},  {having, {}}, {order_by, []}].
table_exp -> from_clause              hierarchical_query_clause                               order_by_clause : ['$1', {where, {}}, '$2',                       {group_by, []},  {having, {}}, '$3'].
table_exp -> from_clause              hierarchical_query_clause                 having_clause                 : ['$1', {where, {}}, '$2',                       {group_by, []},  '$3',         {order_by, []}].
table_exp -> from_clause              hierarchical_query_clause                 having_clause order_by_clause : ['$1', {where, {}}, '$2',                       {group_by, []},  '$3',         '$4'].
table_exp -> from_clause              hierarchical_query_clause group_by_clause                               : ['$1', {where, {}}, '$2',                       '$3',              {having, {}}, {order_by, []}].
table_exp -> from_clause              hierarchical_query_clause group_by_clause               order_by_clause : ['$1', {where, {}}, '$2',                       '$3',              {having, {}}, '$4'].
table_exp -> from_clause              hierarchical_query_clause group_by_clause having_clause                 : ['$1', {where, {}}, '$2',                       '$3',              '$4',         {order_by, []}].
table_exp -> from_clause              hierarchical_query_clause group_by_clause having_clause order_by_clause : ['$1', {where, {}}, '$2',                       '$3',              '$4',         '$5'].
table_exp -> from_clause where_clause                                                                         : ['$1', '$2',        {hierarchical_query, {}}, {group_by, []},  {having, {}}, {order_by, []}].
table_exp -> from_clause where_clause                                                         order_by_clause : ['$1', '$2',        {hierarchical_query, {}}, {group_by, []},  {having, {}}, '$3'].
table_exp -> from_clause where_clause                                           having_clause                 : ['$1', '$2',        {hierarchical_query, {}}, {group_by, []},  '$3', {order_by, []}].
table_exp -> from_clause where_clause                                           having_clause order_by_clause : ['$1', '$2',        {hierarchical_query, {}}, {group_by, []},  '$3',         '$4'].
table_exp -> from_clause where_clause                           group_by_clause                               : ['$1', '$2',        {hierarchical_query, {}}, '$3',              {having, {}}, {order_by, []}].
table_exp -> from_clause where_clause                           group_by_clause               order_by_clause : ['$1', '$2',        {hierarchical_query, {}}, '$3',              {having, {}}, '$4'].
table_exp -> from_clause where_clause                           group_by_clause having_clause                 : ['$1', '$2',        {hierarchical_query, {}}, '$3',              '$4',         {order_by, []}].
table_exp -> from_clause where_clause                           group_by_clause having_clause order_by_clause : ['$1', '$2',        {hierarchical_query, {}}, '$3',              '$4',         '$5'].
table_exp -> from_clause where_clause hierarchical_query_clause                                               : ['$1', '$2',        '$3',                       {group_by, []},  {having, {}}, {order_by, []}].
table_exp -> from_clause where_clause hierarchical_query_clause                               order_by_clause : ['$1', '$2',        '$3',                       {group_by, []},  {having, {}}, '$4'].
table_exp -> from_clause where_clause hierarchical_query_clause                 having_clause                 : ['$1', '$2',        '$3',                       {group_by, []},  '$4', {order_by, []}].
table_exp -> from_clause where_clause hierarchical_query_clause                 having_clause order_by_clause : ['$1', '$2',        '$3',                       {group_by, []},  '$4',         '$5'].
table_exp -> from_clause where_clause hierarchical_query_clause group_by_clause                               : ['$1', '$2',        '$3',                       '$4',              {having, {}}, {order_by, []}].
table_exp -> from_clause where_clause hierarchical_query_clause group_by_clause               order_by_clause : ['$1', '$2',        '$3',                       '$4',              {having, {}}, '$5'].
table_exp -> from_clause where_clause hierarchical_query_clause group_by_clause having_clause                 : ['$1', '$2',        '$3',                       '$4',              '$5',         {order_by, []}].
...
hierarchical_query_clause -> START WITH         search_condition CONNECT BY         search_condition : {hierarchical_query, {{start_with, '$3'},       {connect_by, <<>>, '$6'}}}.
hierarchical_query_clause -> START WITH         search_condition CONNECT BY nocycle search_condition : {hierarchical_query, {{start_with, '$3'},       {connect_by, '$6', '$7'}}}.
hierarchical_query_clause -> CONNECT BY         search_condition START WITH         search_condition : {hierarchical_query, {{connect_by, <<>>, '$3'}, {start_with, '$6'}}}.
hierarchical_query_clause -> CONNECT BY nocycle search_condition START WITH         search_condition : {hierarchical_query, {{connect_by, '$3', '$4'}, {start_with, '$7'}}}.

nocycle -> NOCYCLE : <<"nocycle">>.

where_clause -> WHERE search_condition : {where, '$2'}.

group_by_clause  -> GROUP BY column_ref_commalist : {group_by, '$3'}.
...
is_not_null -> IS NOT NULLX : is_not.
...
data_type -> CHARACTER '(' sgn_num ')'        : {<<"character">>, '$3'}.
data_type -> BIGINT                           : <<"bigint">>.
data_type -> BIGINT UNSIGNED                  : <<"bigint unsigned">>.
